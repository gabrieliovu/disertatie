...
SECRET_KEY = env.str(
    "DJANGO_SECRET_KEY",
    default='django-insecure-9fkm8l-z2a-b$kxy0$0cw_o7g^r23k!wxkes7l-7)_l_+1(r+p'
)
...
REDIS_BROKER_URL = env.str("DJANGO_CELERY_BROKER_URL", default="redis://127.0.0.1:6379/0")
